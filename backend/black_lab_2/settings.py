"""
Django settings for black_lab_2 project.
...
WSGI_APPLICATION = 'black_lab_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_lab_2 API",
    "DESCRIPTION": "API documentation for black_lab_2 App",
    "VERSION": "v1",
}
